...
public class StandardBookServiceTest {
	...
	@Before
	public void setup() {
		aBook = new Book("title", "author", "edition", "isbn", "desc",2016);
		aCopyofBook = new Book("title", "author", "edition", "isbn", "desc",2016);
		anotherBook = new Book("title2", "author2", "edition2", "isbn2", "desc",2016);

		aBorrowedBook = new Book("title", "author", "edition", "isbn", "desc",2016);
		aBorrowing = new Borrowing(aBorrowedBook, BORROWER_EMAIL, NOW);
		aBorrowedBook.borrowNowByBorrower(BORROWER_EMAIL);

		aCopyofBorrowedBook = new Book("title", "author", "edition", "isbn", "desc",2016);
		...
		anotherBorrowedBook = new Book("title2", "author2", "edition2", "isbn2", "desc",2016);
